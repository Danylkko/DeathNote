...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/Danylkko/DeathNote.git"
  ...
  # Or just: spec.author    = "Danylo Litvinchuk"
  # spec.authors            = { "Danylo Litvinchuk" => "ltvnchkd@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Danylo Litvinchuk"
  ...
  spec.source       = { :git => "https://github.com/Danylkko/DeathNote", :tag => spec.version.to_s }
